...
import requests
from prometheus.infra.config import CONFIG, VISUAL_STATE_PATH
from prometheus.memory.memory import MemoryStore
...
class ToolRegistry:
    ...
    def _execute_one_inner(self, payload: dict[str, Any]) -> ToolResult:
        ...
        if action == "query_vault":
            try:
                from prometheus.memory.memory_core import query_vault as _qv
