...
class Planner:
    ...
    def _llm_plan(self, intent: str, context: dict[str, Any]) -> Plan:
        try:
            ...
            from prometheus.context.cognition import build_safe_snapshot, format_operational_state_block
            from prometheus.planning.decision_router import DecisionRouter
