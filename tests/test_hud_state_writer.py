...
class TestCanonicalPath:
    ...
    def test_canonical_path_is_under_desktop_prometheus_state(self):
        from prometheus.hud.hud_state_writer import _DASHBOARD_STATE_PATH
    ...
    def test_write_dashboard_state_creates_correct_file(self, tmp_path):
        import prometheus.hud.hud_state_writer as _mod
...
class TestBuildHudState:
    ...
    def test_news_card_has_10_articles(self):
        from prometheus.hud.hud_state_writer import build_hud_state
...
class TestCalendarCardPayload:
    ...
    def test_is_next_flagged_for_future_event(self):
        from prometheus.hud.hud_state_writer import _calendar_card_payload
...
class TestFetchNewsInternal:
    ...
    def test_fetch_news_returns_fallback_on_network_error(self):
        from prometheus.hud.hud_state_writer import _fetch_news
        with patch("prometheus.news.guardian_news.fetch_guardian_articles",
                   side_effect=RuntimeError("network error")), \
             patch("prometheus.news.guardian_news._load_env_key",
...
class TestGoogleColorMap:
    ...
    def test_color_map_has_11_entries(self):
        from prometheus.hud.hud_state_writer import _GOOGLE_COLOR_MAP
...
class TestCalendarEventColorFields:
    ...
    def test_all_11_color_ids_resolve(self):
        from prometheus.hud.hud_state_writer import _calendar_card_payload, _GOOGLE_COLOR_MAP
...
class TestEventToDictColorId:
    ...
    def test_color_id_extracted_from_raw(self):
        ...
        from prometheus.calendar.read_tools import _event_to_dict
