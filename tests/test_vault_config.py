...
class TestQueryVaultGuards:
    ...
    def test_missing_db_returns_empty_list(self, tmp_path):
        ...
        with patch("memory_core.CONFIG", {"vault_path": str(tmp_path)}):
            assert query_vault("prometheus") == []
    ...
    def test_nonexistent_path_returns_empty_list(self):
        ...
        with patch("memory_core.CONFIG", {"vault_path": "/nonexistent/path/that/does/not/exist"}):
            assert query_vault("prometheus") == []
...
class TestQueryVaultLive:
    ...
    def test_returns_list(self):
        ...
        with patch("memory_core.CONFIG", {"vault_path": _VAULT_PATH}):
